...
class Background:
    ...
    def info_screen(self):
        ...
        self.g_msg_img_rect.center = self.screen.get_rect().width//2, self.screen.get_rect().height/2 - self.esc_msg_img_rect.height - 15
        ...
        self.r_msg_img_rect.center = self.screen.get_rect().width//2, self.screen.get_rect().height/2 + self.esc_msg_img_rect.height + 15
        ...
        self.mov_msg_img_rect.center = self.screen.get_rect().width//2, self.screen.get_rect().height/2 + self.esc_msg_img_rect.height*2 + 30
